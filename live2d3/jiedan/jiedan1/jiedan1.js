// const home_Path = "../jiedan1";
const home_Path = "https://cdn.jsdelivr.net/gh/mizhiyugan529/resource2/live2d3/jiedan/jiedan1";
...
function allthescript() {
    $("body").prepend('<div id="live2ddiv" style="-khtml-user-select: none; user-select: none;-moz-user-select:none;touch-action: none;position: fixed; opacity: 1; left: 0px; bottom: 0px; z-index: 99999; width:200px;height:200px;"><canvas id="live2d" width="700" height="700" class="live2d" style="width:350px;height:350px;pointer-events: none;"></canvas></div>')
    ...
    var modelDir = ['jiedan1']; // 指定需要加载的模型
