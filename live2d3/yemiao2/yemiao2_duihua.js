// const home_Path = "../yemiao2";
const home_Path = "https://cdn.jsdelivr.net/gh/mizhiyugan529/resource2/live2d3/yemiao2";
//目前时间判定
...
function allthescript() {
    ...
    var modelDir = ['yemiao2']; // 指定需要加载的模型
    ...
    setTimeout(function () {
        ...
        $("#live2ddiv").click(function () {
                playLive2dMotion("ye", Math.round(Math.random()), 3);
            const list_click=["来来来吃点东西，我请客","别闹","哎你别说，我还真有点招蚊子，这大夏天的","这批新鼠标手感挺不错啊，等等，让你试手感的是鼠标……"]
            if (now >= 21 || now <= 5){
...
//
    ...
    function move() {
        if (flag) {
            var list_move=["嗯这个速度可以，还要再练练","快快！咱们分头行动"]
            if (now >= 21 || now <= 5){
